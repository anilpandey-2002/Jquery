...
// ready means when document is loaded fully then function is performed
...
// now dollar is not used below declaration
// $.noConflict();
...
// now $ can be used pass it in function
// jQuery.noConflict();
// jQuery(document).ready(function ($) {
//   jQuery("button").click(function () {
//     console.log("clicked");
...
//   // all $ will work inside only not outside
// });
